...
class RssFeed:
    ...
    def __init__(self, **kwargs):
        ...
        self.last_title: str = kwargs.get("last_title")
        self.last_link: str = kwargs.get("last_link")
        self.last_time: str = kwargs.get("last_time")
        ...
        self.embed_color: str = kwargs.get("embed_color")
        self.embed_image: str = kwargs.get("embed_image")
        self.embed_thumbnail: str = kwargs.get("embed_thumbnail")
