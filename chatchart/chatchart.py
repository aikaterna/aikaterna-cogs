...
class Chatchart:
    ...
    def create_chart(self, top, others):
        ...
        title.set_ha("left")
        plt.gca().axis("equal")
        colors = ['r', 'darkorange', 'gold', 'y', 'olivedrab', 'green', 'darkcyan', 'mediumblue', 'darkblue', 'blueviolet', 'indigo', 'orchid', 'mediumvioletred', 'crimson', 'chocolate', 'gray']
        pie = plt.pie(sizes, colors=colors, startangle=0)
        plt.legend(pie[0], labels, bbox_to_anchor=(0.7, 0.45), loc="center", fontsize=10,
    ...
    async def chatchart(self, ctx):
        ...
        e = discord.Embed(description="Loading...", colour=ctx.guild.me.top_role.colour)
        ...
        top_ten = heapq.nlargest(15, [(x, msg_data['users'][x][y])
        ...
        await em.delete()
        await channel.send(file=discord.File(img, 'chart.png'))
